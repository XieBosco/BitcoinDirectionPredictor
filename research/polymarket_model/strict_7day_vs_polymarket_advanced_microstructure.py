...
This advanced variant further adds:
- Kinetic energy of price
- Sub-candle tick entropy
- Micro-acceleration decay
- Time-to-extreme ratios
- Tick continuation vs reversal ratio
"""
...
def run_walk_forward_test(
    ...
    if requested_feature_cols is None:
        requested_feature_cols = list(ALL_MODEL_FEATURES)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="research/polymarket_model/strict_7day_vs_pm_advanced_microstructure_results",
